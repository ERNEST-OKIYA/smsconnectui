<template>
  ...
  >
  <b-card-body>
      <b-card-sub-title>Delivery and Usage by Operator Count</b-card-sub-title>
    </b-card-body>
    <b-table
      :items="tableData"
      responsive
...
<script>
import {
  BCard, BTable, BAvatar, BCardSubTitle, BCardBody,
} from 'bootstrap-vue'
...
export default {
  ...
  data() {
    return {
      tableData: [
        {
          avatarImg: ('@/assets/images/icons/toolbox.svg'),
          title: 'Dixons',
